...
export function StatusStrip({
  ...
  return (
    <div className="bg-white border-b border-gray-200 px-3 py-2.5 sticky top-14 z-40 sm:hidden shadow-sm">
      ...
      <div className="flex items-center justify-between gap-3 text-xs">
        ...
        <div className="flex items-center gap-1.5 flex-1">
          ...
          <span className="text-gray-700 font-medium w-8 text-right tabular-nums">{hp}</span>
        </div>
        ...
        <div className="flex items-center gap-1.5 flex-1">
          ...
          <span className="text-gray-700 font-medium w-8 text-right tabular-nums">{energy}</span>
        </div>
